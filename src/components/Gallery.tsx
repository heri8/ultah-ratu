...
export const Gallery: React.FC = () => {
  ...
  const photos: Photo[] = [
    {
      id: 1,
      url: "/ultah-ratu/images/img-1.jpeg",
      caption:
        "Senyum manis di tangga Petak Enam. Sesederhana itu, tapi selalu enak dipandang.",
      colSpan: "md:col-span-1",
      aspect: "aspect-[3/4]",
    },
    {
      id: 2,
      url: "/ultah-ratu/images/img-2.jpeg",
      caption:
        "Selfie di sela jam kerja. Meski lagi sibuk, senyummu tetap nggak pernah absen.",
      colSpan: "md:col-span-2",
      aspect: "aspect-video",
    },
    {
      id: 3,
      url: "/ultah-ratu/images/img-3.jpeg",
      caption:
        "Naik sampai puncak bareng teman-teman. Capeknya lewat, kenangannya tetap tinggal.",
      colSpan: "md:col-span-1",
      aspect: "aspect-[3/4]",
    },
    {
      id: 4,
      url: "/ultah-ratu/images/img-4.jpeg",
      caption:
        "Foto bareng setelah seru-seruan. Salah satu momen yang rasanya sayang kalau nggak diabadikan.",
      colSpan: "md:col-span-2",
      aspect: "aspect-[4/3]",
    },
    {
      id: 5,
      url: "/ultah-ratu/images/img-5.jpeg",
      caption:
        "Selfie sebelum mulai kerja. Simpel, tapi selalu berhasil bikin suasana jadi lebih cerah.",
      colSpan: "md:col-span-1",
      aspect: "aspect-[3/4]",
    },
    {
      id: 6,
      url: "/ultah-ratu/images/img-6.jpeg",
      caption:
        "Ikut merayakan hari bahagia teman. Pelukan hangat dan senyum tulus yang selalu bikin nyaman.",
      colSpan: "md:col-span-1",
      aspect: "aspect-[3/4]",
    },
    {
      id: 7,
      url: "/ultah-ratu/images/img-7.jpeg",
      caption:
        "Buka puasa bareng di event KapanLagi. Momen sederhana yang ternyata jadi salah satu kenangan terbaik.",
      colSpan: "md:col-span-1",
      aspect: "aspect-[3/4]",
    },
    {
      id: 8,
      url: "/ultah-ratu/images/img-8.jpeg",
      caption:
        "Pose monyong andalan pas makan KBBQ. Kelihatannya iseng, tapi justru jadi foto favorit.",
      colSpan: "md:col-span-2",
      aspect: "aspect-[4/3]",
    },
    {
      id: 9,
      url: "/ultah-ratu/images/img-9.jpeg",
      caption:
        "Di balik headphone dan padatnya pekerjaan, senyummu tetap jadi penyemangat.",
      colSpan: "md:col-span-1",
      aspect: "aspect-video",
    },
    {
      id: 10,
      url: "/ultah-ratu/images/img-10.jpeg",
      caption:
        "Menjelajah tempat baru dan berhenti sejenak buat foto. Momen sederhana yang selalu menyenangkan.",
      colSpan: "md:col-span-1",
      aspect: "aspect-[3/4]",
    },
    {
      id: 11,
      url: "/ultah-ratu/images/img-11.jpeg",
      caption:
        "Ekspresi yang selalu berhasil bikin senyum sendiri. Apa adanya, dan itu yang paling berkesan.",
      colSpan: "md:col-span-1",
      aspect: "aspect-[3/4]",
    },
    {
      id: 12,
      url: "/ultah-ratu/images/img-12.jpeg",
      caption:
        "Sampai di Puncak Paniisan 846 MDPL dengan senyum penuh bangga. Selamat ulang tahun, semoga semua langkahmu selalu membawa kebahagiaan dan cerita indah. ❤️",
  ...
  return (
    <section className="py-32 px-6 max-w-5xl mx-auto space-y-16">
      <div className="space-y-3 text-center md:text-left">
        <span className="text-[10px] uppercase tracking-[0.3em] text-brand-text/40 block">
          Captured Moments
        </span>
        <h2 className="text-3xl font-extralight text-brand-text tracking-wide">
          Lembaran Memori
        </h2>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {photos.map((photo, index) => (
          ...
          >
            <div
              className={`w-full ${photo.aspect} overflow-hidden rounded-xl bg-neutral-50 relative`}
            >
              <img
                src={photo.url}
                alt={photo.caption}
